...
export function Post({ author, publishedAt, content }: PostProps) {
  ...
  function handleCommentEmpty(event: InvalidEvent<HTMLTextAreaElement>) {
  ...
  return (
    <article className={styles.post}>
      ...
      <form className={styles.commentForm} onSubmit={handleCreateNewContent} >
